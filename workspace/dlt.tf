    ...
    curl -X PUT -H "Authorization: Bearer ${var.workspace_token}" -H 'Content-Type: application/json' ${var.workspace_host}/api/2.0/pipelines/${each.value.id} -d '
{
    ...
    "libraries": [
        {
            "notebook": {
                "path": "/Repos/leoneller@yahoo.com.au/AWS-ISV-Summit/dlt/sql/00_etl_dlt_bronze"
            }
        },
        {
            "notebook": {
                "path": "/Repos/leoneller@yahoo.com.au/AWS-ISV-Summit/utils/udfs"
            }
        },
        {
            "notebook": {
                "path": "/Repos/leoneller@yahoo.com.au/AWS-ISV-Summit/dlt/sql/20_etl_dlt_gold"
            }
        },
        {
            "notebook": {
                "path": "/Repos/leoneller@yahoo.com.au/AWS-ISV-Summit/dlt/sql/10_etl_dlt_silver"
            }
        }
    ],
    ...
    curl -X PUT -H "Authorization: Bearer ${var.workspace_token}" -H 'Content-Type: application/json' ${var.workspace_host}/api/2.0/pipelines/${each.value.id} -d '
{
    ...
    "libraries": [
        {
            "notebook": {
                "path": "/Repos/leoneller@yahoo.com.au/AWS-ISV-Summit/dlt/python/00_etl_dlt_bronze"
            }
        },
        {
            "notebook": {
        ...
        {
            "notebook": {
                "path": "/Repos/leoneller@yahoo.com.au/AWS-ISV-Summit/dlt/python/20_etl_dlt_gold"
            }
        },
        {
            "notebook": {
                "path": "/Repos/leoneller@yahoo.com.au/AWS-ISV-Summit/dlt/python/10_etl_dlt_silver"
            }
        }
    ],
    "name": "${each.value.name}",
